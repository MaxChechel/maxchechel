...
var require_Flip = __commonJS({
  "node_modules/gsap/dist/Flip.js"(exports, module) {
    (function(global, factory) {
      ...
      var _id = 1, _toArray, gsap, _batch, _batchAction, _body$1, _closestTenth, _getStyleSaver, _forEachBatch = function _forEachBatch2(batch, name) {
      ...
      var ElementState = function() {
        ...
        _proto2.update = function update(props, simple) {
          var self2 = this, element = self2.element, getProp = gsap.getProperty(element), cache = gsap.core.getCache(element), bounds = element.getBoundingClientRect(), bbox = element.getBBox && typeof element.getBBox === "function" && element.nodeName.toLowerCase() !== "svg" && element.getBBox(), m = simple ? new Matrix2D(1, 0, 0, 1, bounds.left + _getDocScrollLeft(), bounds.top + _getDocScrollTop()) : getGlobalMatrix(element, false, false, true);
      ...
      exports2.Flip = Flip;
      exports2.default = Flip;
      Object.defineProperty(exports2, "__esModule", { value: true });
    });
  }
});
export default require_Flip();
...
gsap/dist/Flip.js:
  ...
  *)
*/
//# sourceMappingURL=gsap_dist_Flip.js.map
